...
app.secret_key = 'cyberscope_super_secret_key_2026'
...
# --- Protected Views (Notice the @login_required decorators) ---
...
def export_pdf():
    ...
    # Create a secure temporary file for the PDF generation
    fd, temp_path = tempfile.mkstemp(suffix='.pdf')
    os.close(fd)
    
    generate_incident_pdf(incidents, temp_path)
...
# --- Unprotected APIs (Kept open so the simulator script can still reach them) ---
